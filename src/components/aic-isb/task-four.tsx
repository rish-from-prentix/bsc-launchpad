...
const SUCCESS_MOMENT: Record<ThemeId, string> = {
  ai: "Aarav rebuilt the onboarding flow with guided setup and prebuilt templates. Within a week, drop-off went from 72% to single digits. The product team is calling it the biggest unlock since launch. Great job. You just saved Cortexynth.",
  climate:
    "Rhea's team built an EV density scoring model and paused expansion into unvalidated zones. Utilization at existing high-demand stations climbed 34% in the first week as resources were redirected. Great job. You just saved Aerovantage.",
  health:
    "Dr. Sharma's team shipped AI-based alert prioritization. Doctor login rates recovered within the first week. Three hospitals that were about to churn signed renewals. Great job. You just saved Vitalyne.",
};
