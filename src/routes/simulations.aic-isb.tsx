      ...
      <div className="flex">
        ...
        {openEmail ? (
          <EmailReader
            ...
            ctaLabel={openEmail.phase === 2 ? "Review Shortlisted Startups" : openEmail.phase === 3 ? "Start Mentor Mapping" : openEmail.phase === 4 ? "Start your investigation" : `Start Phase ${openEmail.phase}`}
