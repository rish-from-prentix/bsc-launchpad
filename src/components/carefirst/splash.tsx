    ...
    >
      ...
      <div className="flex-1 flex items-center justify-center px-5 sm:px-8 py-12">
        <div className="w-full max-w-2xl text-center">
          <div className="text-[11px] uppercase tracking-[0.28em] text-primary font-semibold mb-3">
            CareFirst × PulseTech
          </div>
          ...
          <p className="mt-6 text-[15px] text-muted-foreground max-w-[520px] mx-auto leading-relaxed">
            Step into the role of a Healthcare Business Analyst Intern.
            <br />
            Diagnose a real operational problem. Recommend a real fix.
          </p>

          <div className="mt-10 mx-auto max-w-xl">
            <div
              className="relative aspect-video rounded-xl bg-card overflow-hidden group cursor-pointer"
          ...
          <div className="mt-10 mx-auto max-w-sm">
            ...
            <input
              ...
              className="w-full rounded-lg border border-[#2A2A2A] bg-card px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/60 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30 transition"
            />
            ...
            <p className="mt-3 text-xs text-muted-foreground">
              ~2–3 hours across 15 tasks, self-paced
            </p>
          </div>
        </div>
      </div>
